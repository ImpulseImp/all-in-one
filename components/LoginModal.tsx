...
import bgImg from "@/public/images/login-modal/image.jpg";
import googleImg from "@/public/images/login-modal/google.png";
import facebookImg from "@/public/images/login-modal/facebook.png";
      ...
      <div className="relative m-6 flex flex-col space-y-10 rounded-2xl bg-white shadow-2xl md:m-0 md:flex-row md:space-y-0">
        ...
        <div className="p-6 md:p-20">
          ...
          <div className="mt-6 flex flex-col items-center justify-between space-y-6 md:flex-row md:space-y-0">
            ...
            <button className="hover:bg-opacity-90 flex w-full items-center justify-center space-x-4 rounded-md border bg-cyan-700 p-6 px-9 font-sans font-bold text-white shadow-sm shadow-cyan-100 transition duration-150 hover:-translate-y-0.5 hover:shadow-lg md:w-auto">
              <span>Next</span>
              <svg
          ...
          <div className="flex flex-col space-y-6 space-x-0 md:flex-row md:space-y-0 md:space-x-4">
            <button className="hover:bg-opacity-30 flex items-center justify-center space-x-3 rounded border border-gray-300 py-2 shadow-sm transition duration-150 hover:-translate-y-0.5 hover:shadow-lg md:w-1/2">
              <Image src={facebookImg} alt="" className="w-9" />
              <span className="font-thin">Facebook</span>
            </button>
            <button className="hover:bg-opacity-30 flex items-center justify-center space-x-3 rounded border border-gray-300 py-2 shadow-sm transition duration-150 hover:-translate-y-0.5 hover:shadow-lg md:w-1/2">
              <Image src={googleImg} alt="" className="w-9" />
        ...
        <Image src={bgImg} alt="water" className="hidden w-[430px] md:block" />
        {/* Close Button */}
